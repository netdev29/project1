<h3>Add Taxpayer</h3>
<p>Please fill out the form below to add a taxpayer</p>
<div class="col-md-8" style="padding: 0;">
	<div class="panel panel-default">
		<div class="panel-body">
			<?php echo form_open('taxpayers/add'); ?>
				...
				<div class="form-group col-md-12">
					...
					<input class="form-control" type="text" name="tax_id_number" value="<?php echo set_value('tax_id_number'); ?>">
